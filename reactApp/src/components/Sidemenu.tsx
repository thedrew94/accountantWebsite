      ...
      <div className="inner_menu">
        ...
        <div className="menu_bottom">
          ...
          >
            ...
            <p>Chiedi una consulenza gratuita</p>
          </a>
          <img src="./assets/logoBlue.png" alt="" width="225px" draggable="false" />
        </div>
      </div>
    </div>
  );
