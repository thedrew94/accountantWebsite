export default function InfoOverviewMobile() {
  return (
    <div className="brief_mobile">
      <h2>LE NOSTRE FIGURE PROFESSIONALI</h2>
      <h3>Tutte le nostre figure a lavoro per te</h3>
      <ul className="brief_mobile_ul">
        <li>
          <a href="#services">
            <div className="brief_mobile_svg">
